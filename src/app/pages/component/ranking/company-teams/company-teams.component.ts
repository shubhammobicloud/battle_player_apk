...
import { CompanyteamService } from 'src/app/services/ranking/companyteam.service';
...
export class CompanyTeamsComponent {
  ...
  constructor(private http: HttpClient,private rankingService:CompanyteamService) {}
